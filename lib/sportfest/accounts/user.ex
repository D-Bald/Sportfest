defmodule Sportfest.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Sportfest.Repo)
  ...
  """
  def valid_password?(%Sportfest.Accounts.User{hashed_password: hashed_password}, password)
