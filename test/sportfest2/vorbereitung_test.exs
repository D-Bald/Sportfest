defmodule Sportfest2.VorbereitungTest do
  ...
  describe "klassen" do
    ...
    test "create_klasse/1 with valid data creates a klasse" do
      valid_attrs = %{klassen_scoreboard: "some klassen_scoreboard", name: "some name", schueler: "some schueler", summe: 42}

      assert {:ok, %Klasse{} = klasse} = Vorbereitung.create_klasse(valid_attrs)
      assert klasse.klassen_scoreboard == "some klassen_scoreboard"
    ...
    test "update_klasse/2 with valid data updates the klasse" do
      ...
      assert klasse.klassen_scoreboard == "some updated klassen_scoreboard"
  ...
  describe "schueler" do
    ...
    test "create_schueler/1 with valid data creates a schueler" do
      valid_attrs = %{jahrgang: "some jahrgang", klasse: "some klasse", name: "some name", schueler_scoreboard: "some schueler_scoreboard"}
      ...
      assert schueler.schueler_scoreboard == "some schueler_scoreboard"
    end
    ...
    test "update_schueler/2 with valid data updates the schueler" do
      ...
      assert schueler.schueler_scoreboard == "some updated schueler_scoreboard"
    end
